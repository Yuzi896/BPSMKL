...
// // [[Rcpp::export]]
// double cal_lik(const vec& gammas,
//                const vec& betas,
//                const vec& Y,
//                const vec& constants,
...
// This is for if we want to simulate data from the model assumption.
// Internal helper for the optimized sampler; the R-facing get_K wrapper uses
// get_K_cpp() from multiple_lambda_helper_no_fx_beta.cpp.
arma::mat get_K(int update,
                const arma::mat& X,
                const arma::mat& Eta,
                const arma::vec& lambda,
                const Rcpp::IntegerMatrix& idx,
